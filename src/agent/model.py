...
class Model(nn.Module):
    ...
    def __init__(self):
        ...
        in_channels = shapes["conv3"]["outChannels"]
        self._attn_dim = _CONFIG_MODEL["attnDim"]
        self._num_heads = _CONFIG_MODEL["numAttHeads"]
        self._attn_scale = self._attn_dim**-0.5
    ...
    def forward(
        ...
        scores = torch.matmul(q, k.transpose(-1, -2)) * self._attn_scale  # [B, H_heads, 1, H_conv*W_conv]
        ...
        logits_nonsequential = self._policy_head(gru_out)  # [N * T, V]
